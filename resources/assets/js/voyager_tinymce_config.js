...
var getConfig = function(options) {
    ...
    var baseTinymceConfig = {
        ...
        toolbar: 'styleselect | bold italic underline | forecolor backcolor | fontfamily | alignleft aligncenter alignright | bullist numlist outdent indent | link image table | code',
        image_caption: true,
        image_title: true,
